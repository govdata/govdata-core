...
root = '../Words/WordFrequencyData/'

def Initialize(creates = root):
	MakeDir(root)

def GetFiles(depends_on = 'http://en.wiktionary.org/wiki/Wiktionary:Frequency_lists/',creates = (root + '1To10000.html',root + '10001To20000.html',root + '20001To30000.html',root + '30001To40000.html')):
	for (s,e) in [(1,10000),(10001,20000),(20001,30000),(30001,40000)]:
		os.system('wget http://en.wiktionary.org/wiki/Wiktionary:Frequency_lists/PG/2006/04/' + str(s) + '-' + str(e) + ' -O ' + root + str(s) + 'To' + str(e) + '.html')
		
def ParseFiles(depends_on =  (root + '1To10000.html',root + '10001To20000.html',root + '20001To30000.html',root + '30001To40000.html'), creates = root + 'WordFrequencies.csv'):
...
def HiAssocWords(page,depends_on = root + 'WordFrequencies.csv'):
